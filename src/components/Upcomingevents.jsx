          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-300 pb-3 mb-6">
            <nav className="flex space-x-4 text-sm font-semibold">
              ...
              <button
                ...
                className={`uppercase pb-2 ${activeTab === 'workshops' ? 'text-black border-b-2 border-sky-500' : 'text-gray-500'}`}
              >
                Short-Term Workshops
              </button>
            </nav>
            <a href="#" className="flex items-center text-sm font-semibold text-black hover:underline mt-4 sm:mt-0">
              <CalendarIcon />
              See Upcoming Events
            </a>
          </div>
